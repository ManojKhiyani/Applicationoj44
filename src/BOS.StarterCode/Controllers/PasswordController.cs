...
namespace BOS.StarterCode.Controllers
{
    ...
    public class PasswordController : Controller
    {
        ...
        public PasswordController(IConfiguration configuration, IHttpContextAccessor contextAccessor, SessionHelpers sessionHelpers)
        {
                ...
                if (password != null)
                {
                    ...
                    if (newPassword != null)
                    {
                        ...
                        if (response != null && response.IsSuccessStatusCode)
                        {
                            ...
                            return View("ResetPassword", new ChangePassword());
                        }
                        else
                        {
