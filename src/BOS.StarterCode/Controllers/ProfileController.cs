                ...
                if (data != null) //Checking for non-null data
                {
                    if (User != null) //Checking for claims
                    {
                        ...
                        User user = new User
                        {
                            ...
                            Deleted = false,
                            Email = HttpUtility.HtmlEncode(data["Email"]?.ToString()),
                            FirstName = HttpUtility.HtmlEncode(data["FirstName"]?.ToString()),
                            LastModifiedOn = DateTime.UtcNow,
                            LastName = HttpUtility.HtmlEncode(data["LastName"]?.ToString()),
