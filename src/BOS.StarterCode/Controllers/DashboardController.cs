...
namespace BOS.StarterCode.Controllers
{
    ...
    public class DashboardController : Controller
    {
        ...
        public IActionResult Index()
        {
            try
            {
                return View("_Index",GetPageData()); //Returns to the view with the data required to paint it
            }
            catch (Exception ex)
            {
        ...
        public IActionResult NavigationMenu(string selectedModuleId)
        {
            try
            {
                ...
                return View("_Index", model); //Returing to the Index view with the data
            }
            catch (Exception ex)
            {
