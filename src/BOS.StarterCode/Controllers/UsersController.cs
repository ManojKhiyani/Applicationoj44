...
using BOS.StarterCode.ActionFilters;
using System.Web;
                ...
                if (data != null) //Confirm non-null input data
                {
                    ...
                    if (userObj != null) //Checking for a non-null userObj
                    {
                        if (userObj.Username != null && userObj.Email != null && password != null) //Non-null values
                        {
                            ...
                            {
                                userObj.FirstName = HttpUtility.HtmlEncode(userObj.FirstName);
                                userObj.LastName = HttpUtility.HtmlEncode(userObj.LastName);
                                userObj.Username = HttpUtility.HtmlEncode(userObj.Username);
                                userObj.Email = HttpUtility.HtmlEncode(userObj.Email);
