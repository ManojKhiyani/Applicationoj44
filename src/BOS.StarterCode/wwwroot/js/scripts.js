...
$(function() {
  ...
  var toggle_sidebar_mini = function(mini) {
    ...
    $("[data-toggle='sidebar']").click(function (event) {
        ...
        if ($(event.currentTarget).children("i").hasClass("fa-chevron-left")) {
            $(event.currentTarget).children("i").removeClass("fa-chevron-left").addClass("fa-chevron-right");
        }
        else {
            $(event.currentTarget).children("i").removeClass("fa-chevron-right").addClass("fa-chevron-left");
        }
    return false;
  });
