...
namespace BOS.StarterCode.Tests
{
    public class AuthControllerTests
    {
        ...
        //    Assert.Equal("_Index", viewResult.ViewName); //Asserting that the returned view is "Index"
        //}
        ...
        //    Assert.Equal("_Index", redirectResult.ActionName); //Asserting that the Action Methond of the controller is "Index"
        //}
        ...
        {
            //Arrange 
            var controller = new AuthController(_configuration, _contextAccessor, _sessionHelpers)
            {
                ControllerContext = new ControllerContext()
                {
            ...
            //Assert
            var viewResult = Assert.IsType<ViewResult>(result); //Asserting that the return is a View
            Assert.Equal("_Index", viewResult.ViewName); //Asserting that the returned Controller is "Index"
